  ...
  return (
    <footer className="bg-slate-950 text-gray-300 pt-16" role="contentinfo">
      <div className="container-custom">
        {/* Newsletter Section */}
        <div className="bg-white/5 border border-white/10 rounded-2xl p-5 lg:p-8 flex flex-col md:flex-row items-center justify-between gap-5 mb-8">
          <div className="flex-1 text-center md:text-left">
            <h3 className="text-lg md:text-xl font-heading font-bold text-white mb-2">Stay Updated with Solar Energy News from AP</h3>
            <p className="text-xs md:text-sm text-gray-400 max-w-[500px] mx-auto md:mx-0">Get the latest information about APEPDCL net metering rules, PM Surya Ghar subsidy updates, solar maintenance tips, and new product launches from Mirror Solar Vision.</p>
          </div>
          <form className="flex w-full md:max-w-[400px] relative mt-2 md:mt-0" aria-label="Newsletter signup">
            <input 
              type="email" 
        ...
        {/* Footer Top Columns */}
        <div className="grid grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1.2fr] gap-x-6 gap-y-10 pb-10">
          {/* Brand Col */}
          <div className="col-span-2 lg:col-span-1 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="mb-4 flex flex-col items-center lg:items-start">
              <img src="/assets/images/logo/msv_logo_500x300.png" alt="Mirror Solar Vision" className="h-20 w-auto mb-4" />
              <p className="text-xs lg:text-sm leading-relaxed text-gray-400 max-w-[300px] hidden md:block">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-3 mt-2">
              <a href="https://wa.me/918639103947" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-9 h-9 bg-white/5 border border-white/10 rounded-full text-gray-400 hover:text-white hover:bg-accent-500 transition-colors" aria-label="WhatsApp">
              ...
              <a href="https://www.facebook.com/share/1Efjcqhpeq/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-9 h-9 bg-white/5 border border-white/10 rounded-full text-gray-400 hover:text-white hover:bg-accent-500 transition-colors" aria-label="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://www.instagram.com/mirror_life_technologies?igsh=MTVyd3g0d2h5dXFsZg==" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-9 h-9 bg-white/5 border border-white/10 rounded-full text-gray-400 hover:text-white hover:bg-accent-500 transition-colors" aria-label="Instagram">
              ...
              <a href="https://youtube.com/@mirrorlife123?si=CREJrBVy3AYRHlGI" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-9 h-9 bg-white/5 border border-white/10 rounded-full text-gray-400 hover:text-white hover:bg-accent-500 transition-colors" aria-label="YouTube">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.5 12 3.5 12 3.5s-7.505 0-9.377.55a3.016 3.016 0 0 0-2.122 2.136C0 8.07 0 12 0 12s0 3.93.498 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.55 9.377.55 9.377.55s7.505 0 9.377-.55a3.016 3.016 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
              </a>
            </div>
          </div>
          ...
          <div className="col-span-1 flex flex-col">
            <h4 className="font-heading text-base font-semibold text-white mb-5 relative pb-3 after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-[30px] after:h-[3px] after:bg-accent-500 after:rounded-full">Solar Solutions & Store</h4>
            <div className="flex flex-col gap-3">
              <a href="#store" onClick={(e) => { if (onNavigate) { e.preventDefault(); onNavigate('store', 'catalog'); } }} className="inline-flex items-center gap-2 text-sm font-bold text-accent-400 hover:text-accent-300 hover:pl-1 transition-all duration-150">Mirror Solar Store 🛒</a>
              <a href="#drain-clips" onClick={(e) => { if (onNavigate) { e.preventDefault(); onNavigate('store', 'drain-clips'); } }} className="inline-flex items-center gap-2 text-sm text-gray-400 hover:text-accent-500 hover:pl-1 transition-all duration-150">Dust & Water Drain Clips</a>
          ...
          <div className="col-span-2 lg:col-span-1 flex flex-col">
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div className="text-sm leading-relaxed text-gray-400 pt-1">
                <strong className="text-gray-300">DURGARAO PERURI</strong><br />
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div className="text-sm leading-relaxed text-gray-400 pt-1.5">
                <a href="tel:+918639103947" className="text-gray-400 hover:text-accent-500 transition-colors">+91 86391 03947</a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div className="text-sm leading-relaxed text-gray-400 pt-1.5">
                <a href="mailto:mirrorsolarvision@gmail.com" className="text-gray-400 hover:text-accent-500 transition-colors">mirrorsolarvision@gmail.com</a>
              </div>
            </div>
          </div>
        </div>
