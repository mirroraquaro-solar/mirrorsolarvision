  ...
  return (
    <section className="relative w-full overflow-hidden flex items-start lg:items-center min-h-[100vh] lg:min-h-[700px] pt-[105px] lg:pt-[118px] scroll-mt-20" id="home" aria-label="Hero banner">
      ...
      <a 
        ...
        className="fixed bottom-6 right-6 z-[9999] bg-[#25D366] hover:bg-[#20BA56] text-white w-14 h-14 rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(37,211,102,0.45)] transition-all duration-300 transform hover:scale-110 hover:rotate-6 active:scale-95"
        aria-label="Chat with Mirror Solar on WhatsApp"
      >
